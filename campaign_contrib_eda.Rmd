...
cand.receipts.summary <-
            Reduce(function(df1, df2) left_join(df1, df2, by="cand_nm"),
                   list(cand.receipts.summary, cand.count))
```
```{r}
...
### Mean/Median Receipts
```{r}
ggplot(data = cand.receipts.summary,
       aes(x = reorder(cand_nm, -mean_receipt))) +
  geom_bar(aes(y = mean_receipt, fill = "Mean"), stat="identity") +
  geom_bar(aes(y = median_receipt, fill = "Median"), stat="identity") +
  horiz_lab +
...
### Summary Table
```{r}
top_30_occupation <- sapply(top_n(occupation.count, 30, n)["contbr_occupation"],
                            FUN = as.character)
...
occupation.receipts.summary <- 
  Reduce(function(df1, df2) left_join(df1, df2, by="contbr_occupation"),
         list(occupation.receipts.summary, occupation.count))
```
```{r}
...
### Mean/Median Receipt
```{r}
ggplot(data = occupation.receipts.summary,
       aes(x = reorder(contbr_occupation, mean_receipt))) +
  geom_bar(aes(y = mean_receipt, fill = "Mean"), stat="identity") +
  geom_bar(aes(y = median_receipt, fill = "Median"), stat="identity") +
  coord_flip() +
...
```{r}
ggplot(data = occupation.receipts.summary,
       aes(x = reorder(contbr_occupation, max_receipt))) +
  geom_bar(aes(y = max_receipt, fill = "Max"), stat="identity") +
  geom_bar(aes(y = min_receipt, fill = "Min"), stat="identity") +
  coord_flip() +
  labs(y = "Receipt Amount", x = "Occupation", fill = "Stat")
...
### Summary Table
```{r}
top_30_employer <- sapply(top_n(employer.count, 30, n)["contbr_employer"],
                          FUN = as.character)
...
employer.receipts.summary <- 
  Reduce(function(df1, df2) left_join(df1, df2, by="contbr_employer"),
         list(employer.receipts.summary, employer.count))
```
```{r}
...
### Mean/Median Receipt
```{r}
ggplot(data = employer.receipts.summary,
       aes(x = reorder(contbr_employer, mean_receipt))) +
  geom_bar(aes(y = mean_receipt, fill = "Mean"), stat="identity") +
  geom_bar(aes(y = median_receipt, fill = "Median"), stat="identity") +
  coord_flip() +
...
```{r}
ggplot(data = employer.receipts.summary,
       aes(x = reorder(contbr_employer, max_receipt))) +
  geom_bar(aes(y = max_receipt, fill = "Max"), stat="identity") +
  geom_bar(aes(y = min_receipt, fill = "Min"), stat="identity") +
  coord_flip() +
  labs(y = "Receipt Amount", x = "Employer", fill = "Stat")
...
```{r}
ggplot(data = employer.receipts.summary,
       aes(x = reorder(contbr_employer, -agg_receipt))) +
  geom_bar(aes(y = agg_receipt), stat="identity") +
  horiz_lab +
...
ggplot(data = date.receipts.summary, aes(x = contb_receipt_dt)) +
  ...
  geom_bar(aes(y = median_receipt, fill = "Median"), stat="identity") +
  horiz_lab +
  labs(title = "Mean/Median Receipts per Month",
       y = "Receipt Amount",
       x = "Date",
       fill = "Stat")
```
